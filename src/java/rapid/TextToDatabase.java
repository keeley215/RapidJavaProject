...
public class TextToDatabase {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            for (chapNo = 1; chapNo < 45; chapNo++) {
                int quesNo = 1;
                String fName = "C:\\Users\\Ginger\\Downloads\\questions\\chapter" + chapNo + ".txt";
                ...
                while ((strLine = br.readLine()) != null) {
                    ...
                    if (strLine.startsWith(quesNo + ".")) {
                        ...
                        try {
                            ...
                            String stmt = "insert into johansen.intro11equiz(chapterNo, "
    ...
    private static void initializeJdbc() {
        try {
            ...
            Connection connection = DriverManager.getConnection("jdbc:mysql://35.185.94.191/johansen", "johansen", "tiger");
